...
template <typename Graph, typename Workitem = Graph::vertex_id_t, typename Queue = std::queue<Workitem>>
...
//****************************************************************************
template <typename Graph, typename Workitem = Graph::vertex_id_t, typename Queue = tbb::concurrent_queue<Workitem>>
