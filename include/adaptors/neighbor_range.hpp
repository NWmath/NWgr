...
class neighbor_range {
  ...
  using vertex_id_type = vertex_id_t;

  using graph_iterator = typename std::conditional<std::is_const_v<Graph>, typename Graph::iterator, typename Graph::iterator>::type;
