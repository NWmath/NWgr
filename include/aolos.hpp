...
public:
  ...
  adj_list(edge_list<directed, Attributes...>& A) : array_of_list_of_structs<size_t, Attributes...>(A.max()[0] + 1) { A.fill(*this); }
  adj_list(edge_list<undirected, Attributes...>& A) : array_of_list_of_structs<size_t, Attributes...>(A.max()[0] + 1) { A.fill(*this); }
