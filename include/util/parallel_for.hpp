...
///
/// 1. Intel's TBB ranges don't model std ranges, so the "iterators" that they
///    return can't necessarily be used as `*i`.
///
/// 2. We would like to automatically unpack tuples and call `op` using their
///    unpacked values.
///
